...
class FileNode:
    def __init__(self,name,isFile,path):
        ...
        self.dataput("data","") # used if it is a file
        self.put("meta",{})
...
class FS:
    ...
    def write_file(self,path,data=None, offset=0, fh=None):
        ...
        node_data = filenode.dataget("data")
        ...
        filenode.dataput("data",node_data)
    ...
    def read_file(self,path,offset=0,size=None):
        ...
        if (size==None):
            ...
            return filenode.dataget("data")[offset:offset + size]
...
if __name__ == "__main__":
  ...
  # Create a new HtProxy object using the specified at the command-line
